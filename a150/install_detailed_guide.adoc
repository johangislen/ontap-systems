...
[.lead]
Learn how to install your AFF A150 system.
...
[.lead]
To install your AFF A150 system, create an account on the NetApp Support Site, register your system, and obtain your license keys. You also need to inventory the appropriate number and type of cables for your system and collect specific network information.
...
--
Learn how to cable a two-node switchless cluster. You can cable your controllers using UTA2 data network or an ethernet network configuration.
