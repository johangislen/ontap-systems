...
* Erase the data on the caching module: Erase the data on the caching module: `system controller flash-cache secure-erase run -node local -slot 2 -device-id 0`
