...
---
= Overview of controller replacement - AFF A800
:icons: font
:imagesdir: ../media/
...
NOTE: Do not downgrade the BIOS version of the _replacement_ controller to match the partner controller or the old controller module.
