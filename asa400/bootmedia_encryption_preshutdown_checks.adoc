---
permalink: asa400/bootmedia-encryption-preshutdown-checks.html
sidebar: sidebar
keywords: asa a400, asa, a400, shut, down, impair, controller, check, status, onboard, encryption, keys, status, disable, automatic, giveback, version, ontap, system, run, pre-shutdown, check, pre-shutdown checks for onboard encryption keys
...
---
= Check onboard encryption - ASA A400
:icons: font
:imagesdir: ../media/
