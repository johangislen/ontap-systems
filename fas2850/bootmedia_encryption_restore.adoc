---
permalink: fas2850/bootmedia-encryption-restore.html
sidebar: sidebar
keywords: fas 2850, post, boot, media, okm, nse, nve, onboard key manager, netapp storage encryption, netapp volume encryption
...
---
= Restore OKM, NSE, and NVE as needed - FAS2850
:icons: font
:imagesdir: ../media/
