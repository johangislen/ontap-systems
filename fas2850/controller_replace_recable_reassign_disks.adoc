...
---
= Recable the system and reassign disks - FAS2800
:icons: font
:imagesdir: ../media/
...
HA pair
a|
link:controller_replace_complete_system_restoration.md#[Verifying the system ID change on an HA system]
a|
Stand-alone
a|
link:controller_replace_complete_system_restoration.md#[Manually reassigning the system ID on a stand-alone system in ONTAP]
a|
Two-node MetroCluster configuration
a|
link:controller_replace_complete_system_restoration.md#[Manually reassigning the system ID on systems in a two-node MetroCluster configuration]
|===
