---
permalink: fas2850/bootmedia-encryption-preshutdown-checks.html
sidebar: sidebar
keywords: fas2850, shutdown, checks, onboard, encryption, keys, impaired controller, disable, automatic, feedback
...
---
= Check onboard encryption keys - AFF FAS2850
:icons: font
:imagesdir: ../media/
