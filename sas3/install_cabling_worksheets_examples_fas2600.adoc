...
image::../media/IEOPS-954, drw_fas2800_noshelf_mpha.svg[width=500px]
...
image::../media/IEOPS-955, drw_fas2800_noshelf_tpha.svg[width=500px]
...
image::../media/IEOPS-948, drw_fas2800_worksheet.svg[width=500px]

image::../media/IEOPS-949, drw_fas2800_withshelves_tpha.svg[width=500px]
