...
== FAS2800 platform in a multipath HA configuration...with one multi-shelf stack?

The following worksheet and cabling example uses port pair 0a/0b1: DO I even need a worksheet for this?
