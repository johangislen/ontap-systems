...
[NOTE]
====
For FAS2800 HA pairs, although the cabling to external shelves is single-path HA, because of each controller's internal connection of port 0c to its partner controller, the HA pair configuration is multipath HA. 
====
