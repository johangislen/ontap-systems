...
* Your system must be a multipath HA, multipath, tri-path HA, quad-path HA, or quad-path configuration.
+
For platforms with internal storage, such as AFF A200, AFF A220, FAS2600 series and FAS2700 systems, the external storage must be cabled as multipath HA or multipath.
+
