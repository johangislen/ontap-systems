...
sidebar: sidebar
keywords: fas8300, fas8700, replace, dimm, shut, down, impaired, controller, module, reinstall, diagnostic, system, controller, aggregates, metrocluster, replacement
...
NOTE: The animation and illustration shows empty slots for sockets without DIMMs. These empty sockets are populated with blanks.
