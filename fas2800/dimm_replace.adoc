...
. If the NVMEM LED is flashing, there is data in the NVMEM and you must disconnect the battery to clear the memory:
 ...
 .. Reconnect the battery connector and recheck the LED on the back of the controller, and then unplug the battery cable again..
...
. Plug in the NVMRM battery.Locate the NVMEM battery plug socket, and then squeeze the clip on the face of the battery cable plug to insert it into the socket.
+
