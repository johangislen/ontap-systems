...
[.lead]
To replace a caching module, locate the slot inside the controller and follow the specific sequence of steps.
...
[.lead]
After you have replaced the caching module in your system, you should run diagnostic tests on that component.
...
== Step 6: Restore automatic giveback and AutoSupport
