...
---
= Replace the real-time clock battery - FAS2800
:icons: font
:imagesdir: ../media/
...
video::7420d100-23b1-4213-a8da-af4701725622[panopto, title="Animation - Replace the RTC battery"]

image::../media/drw_2850_replace_rtc_battery_IEOPS-701.svg[width=340px]
