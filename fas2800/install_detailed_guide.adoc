...
+
***image::../media/ANIMATION LINK HERE for TNSC ANIMATION LINK HERE[Animation - Cabling a two-node switchless cluster]
+
...
a|
Cable the cluster interconnect ports to each other with the cluster interconnect cable: image:../media/oie_cable_25Gb_Ethernet_SFP28_IEOPS-1069.svg[width=100px]

 ** e0a to e0a
 ** e0b to e0b

image:../media/OIE_FAS2800_tnsc_cluster_interconnect_IEOPS-1075[width=85px]
a|
...
a|image:../media/oie_legend_icon_3_o.svg[width=30px]
a|
...
image:../media/OIE_FAS2800_network_connection_IEOPS-1078.svg[width=85px]
...
+
***image::../media/drw_2700_switched_ethernet_network_cabling_animated_gif.svg[width=100px]
+
...
image:../media/drw_fas2800_switched_cluster_interconnect_IEOPS-1076.svg[width=85px]
a|
image:../media/oie_legend_icon_2_lp.svg[width=30px]
a|
Cable the e0M ports to the management network switches with the RJ45 cables:

image:../media/OIE_FAS2800_management_connection_IEOPS-1077[width=85px]
a|image:../media/oie_legend_icon_3_o.svg[width=30px]
a|
Select one of the following cable connections to cable the mezzanine card ports to your host network:
...
+
*****image::../media/drw_2700_ha_storage_cabling_animated_gif.svg[width=100px]
+
...
image:../media/OIE_FAS2800_cable_shelf_to_shelf_IEOPS-1080[width=85px]
...
+
image:../media/oie_cable_mini_sas_hd_to_mini_sas_hd.svg[width=85px]     mini-SAS HD to mini-SAS HD cables
...
+
image::../media/drw_OIE_FAS2800_turn_on_power.svg[width=45px]
+
...
+
image::../media/drw_autodiscovery_controler_select.svg[width=100px]
...
+
image::../media/drw_console_connect_fas2700_affa200.svg[width=100px]

 .. Connect the laptop or console to the switch on the management subnet.
+
image::../media/drw_client_to_mgmt_subnet_fas2700_affa220.svg[width=100px]
...
. Turn on the power switches to both nodes.
+
image::../media/OIE_FAS2800_turn_on_power.svg[width=45px]
+
NOTE: Initial booting may take up to eight minutes.
