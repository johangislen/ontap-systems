...
X6566B-5-R6, 5m
a|
image:../media/oie_cable_25Gb_Ethernet_SFP28.svg[]
a|
Network cable
a|
32Gb Fiber Channel,
...
Four ports::
** 4-ports, 10/25Gb Ethernet, SFP28 - image:../media/oie_cable_sfp_gbe_copper.svg[width=100px] image:../media/oie_cable_25Gb_Ethernet_SFP28.svg[width=100px]
