...
X6566B-5-R6, 5m
a|
image:../media/oie_cable_25Gb_Ethernet_SFP28.svg[width=100px]
a|
Network cable
a|
32Gb Fiber Channel,
...
+
image::../media/oie_fas2800_weight_caution.svg[width=320px]
...
a|
image:../media/oie_legend_icon_1_lg.svg[width=50px]
a|
Cable the cluster interconnect ports to each other with the cluster interconnect cable: image:../media/oie_cable_25Gb_Ethernet_SFP28.svg[width=100px]
...
a|
image:../media/oie_legend_icon_2_lp.svg[width=50px]
a|
...
a|image:../media/oie_legend_icon_3_o.svg[width=50px]
a|
...
a|
image:../media/oie_legend_icon_attn_symbol.svg[width=50px]
a|
...
image:../media/drw_fas2800_switched_clust_cbling.svg[width=100px]
a|
image:../media/oie_legend_icon_2_lp.svg[width=50px]
a|
Cable the e0M ports to the management network switches with the RJ45 cables:
...
| Step| Perform on each controller
a|
image:../media/oie_legend_icon_1_lo.svg[width=100px]
a|
...
a|
image:../media/oie_legend_icon_2_mb.svg[width=100px]
a|
...
+
image:../media/oie_cable_mini_sas_hd_to_mini_sas_hd.svg[width=100px]     mini-SAS HD to mini-SAS HD cables

a|
image:../media/oie_legend_icon_3_t.svg[width=100px]
a|
...
+
image::../media/drw_turn_on_power_switches_to_psus.svg[width=100px]
+
