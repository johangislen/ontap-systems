...
summary: 'Swapping out a power supply involves turning off, disconnecting, and removing the impaired power supply and installing, connecting, and turning on the replacement power supply.'
---
...
+
image::../media/drw_2850_replace_PSU_IEOPS-702.svg[width=500px]
+
