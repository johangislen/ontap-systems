...
sidebar: sidebar
keywords: fas2800, swap, power, supply, turn off, disconnect, remove, old, install, connect, turn on, replacement
...
---
= Swap out a power supply - FAS2800
:icons: font
:imagesdir: ../media/
...
+
video::7420d101-23b1-4213-a8da-af4701725622[panopto, title="Animation - Replace a PSU"]
+
image::../media/drw_2850_replace_PSU_IEOPS-702.svg[width=340px]
+
