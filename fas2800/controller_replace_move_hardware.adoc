...
Remove the mezzanine card from the old controller module.
+
...
Remove the DIMMS from the old controller module ans install them into the replacement controller module.
