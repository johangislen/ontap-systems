...
For All-SAN Array (AFF) systems, follow the installation instructions for the corresponding AFF A-Series model.
...
[role="quick-margin-para"]
After you have configured your switches and installed the required software, access the install and setup instructions for your AFF/FAS platform model to complete your system setup. For All-SAN Array (AFF) systems, follow the installation instructions for the corresponding AFF A-Series model.
