...
[.lead]
This guide gives graphic instructions for a typical installation of your system from racking and cabling, through initial system bring-up. Use the link:../media/PDF/215-13082_2022-08_us-en_AFFC800_ISI.pdf[AFF C800 Installation and Setup Instructions^] if you are familiar with installing NetApp systems.