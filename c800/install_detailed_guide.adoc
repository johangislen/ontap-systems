...
+
image::../media/drw_affc800_weight_caution.png[]

. Attach cable management devices (as shown).
+
image::../media/drw_affc800_install_cable_mgmt.png[]
...
** e0b to e0b
** e1b to e1b
image:../media/drw_affc800_ha_pair_cabling.png[]
...
** e0a to e0a
** e1a to e1a
image:../media/drw_affc800_tnsc_clust_cabling.png[]
a|
image:../media/oie_legend_icon_3_lp.png[]
a|
Cable the management ports to the management network switches    image:../media/drw_affc800_mgmt_cabling.png[]
a|
...
** e0a
** e1a
image:../media/drw_affc800_switched_clust_cabling.png[]
a|
image:../media/oie_legend_icon_3_lp.png[]
a|
Cable the management ports to the management network switches    image:../media/drw_affc800_mgmt_cabling.png[]
...
1
a|
Cable ports 2a through 2d to the FC host switches.image:../media/drw_affc800_fc_host_cabling.png[]
...
1
a|
Cable ports e4a through e4d to the 10GbE host network switches.image:../media/drw_affc800_10gbe_host_cabling.png[]
...
a|
Cable controller A to the shelf:    image:../media/drw_affc800_1shelf_cabling_a.png[]
a|
image:../media/oie_legend_icon_2_lo.png[]
a|
Cable controller B to the shelf:    image:../media/drw_affc800_1shelf_cabling_b.png[]
|===
...
image:../media/oie_legend_icon_1_mb.png[]
a|
Cable controller A to the shelves:    image:../media/drw_affc800_2shelf_cabling_a.png[]
a|
image:../media/oie_legend_icon_2_lo.png[]
a|
Cable controller B to the shelves:    image:../media/drw_affc800_2shelf_cabling_b.png[]
|===
...
+
image::../media/drw_console_connect_affc800.png[]

 .. Connect the laptop or console to the switch on the management subnet.
+
image::../media/drw_client_mgmt_subnet_affc800.png[]
