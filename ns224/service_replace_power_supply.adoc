...
[cols="1,3"]
|===
a| image:../media/legend_icon_01.svg[width=8]
a| Thumb screws
a| image:../media/legend_icon_02.svg[width=8]
a| Power supply cable connector
a| image:../media/legend_icon_03.svg[width=8]
a| Power supply cam handle
a| image:../media/legend_icon_04.svg[width=8]
