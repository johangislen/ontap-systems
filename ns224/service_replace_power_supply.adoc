...
+
The illustration and table in the next step shows the two thumb screws (item #1) and the D-SUB DC power cable connector (item #2).
+
.. Unscrew the two thumb screws on the power cable connector.
.. Unplug the power cable connector from the power supply and set it aside.
...
+
.. Plug the power cable connector into the power supply.
.. Tighten the two thumb screws to secure the power cable connector to the power supply.
--
