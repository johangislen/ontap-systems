...
+
The illustration and table in the next step shows the two thumb screws (item #1) and the D-SUB DC cable connector (item #2).
+
.. Unscrew the two thumb screws on the D-SUB DC cable connector.
.. Unplug the D-SUB DC cable connector from the power supply and set it aside.
...
a| Power supply D-SUB DC cable connector
...
+
.. Plug the D-SUB DC cable connector into the power supply.
.. Tighten the two thumb screws to secure the D-SUB DC cable connector to the power supply.
--
