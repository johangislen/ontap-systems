...
. Disconnect the cabling from the impaired NSM module:
 .. Disconnect the power cord from the power supply by opening the power cord retainer if you have AC power supplies, or unscrewing the two thumbs screws if you have a DC power supply, and then unplug the power cord from the power supply.
+
