...
** "Blinks": The LED turns on and off at a varying interval
** "Any state": The LED can be "On", "Off", or "Blinks"
...
On
a|
BIOS boot from primary BIOS image after power up
a|
...
Any state
a|
BIOS boot from secondary BIOS image after power up
a|
