...
UTA2 ports, Ethernet data network and management ports on the controller modules are connected to switches. The cluster interconnect ports are cabled on both controller modules.
...
a|
image::../media/oie_legend_icon_2_o.svg[width=50px]
a|
Controllers to host data network switches
a|
image::../media/oie_legend_icon_3_lp.svg[width=50px]
a|
