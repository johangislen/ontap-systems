...
CAUTION: The power supply is short. Always use two hands to support it when removing it from the controller module so that it does not suddenly swing free from the controller module and injure you.
+
image::../media/drw_dcpsu_remove-replace-generic_IEOPS-788.svg[width=340px]
+
[cols=1,2]
|===
a|
...
Power cable plug
a|
image:../media/legend_icon_03.svg[width=20px]
PSU cam handle
a|
image:../media/legend_icon_04.svg[width=20px]
Orange locking tab
|===
