...
|===
a|
image:../media/legend_icon_01.svg[width=5px]
a|
Thumb screws
a| 
image:../media/legend_icon_02.svg[width=5px]
a|
D-SUB DC power power supply cable connector
a|
image:../media/legend_icon_03.svg[width=5px]
a|
Power supply handle
a|
image:../media/legend_icon_04.svg[width=5x]
a|
Blue power supply locking tab
|===
