...
[.lead]
This guide gives graphic instructions for a typical installation of your system from racking and cabling, through initial system bring-up. Use the link:../media/PDF/215-13082_2023-09_us-en_AFFA800_ISI.pdf[AFF A800 Installation and Setup Instructions^] if you are familiar with installing NetApp systems.