...
You can use the following illustration with the written steps to remove the controller module from the chassis.
...
You can use the following illustration with the written steps to install the controller module in the chassis.
