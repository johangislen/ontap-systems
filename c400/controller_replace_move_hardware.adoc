...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[width=400px]
+
|===
a|
...
+
Illustration - Remove the empty risers from the replacement controller module
+
image::../media/drw_c400_empty_riser_remove_IEOPS-1225.svg[width=500px]
+
...
image::../media/drw_c400_nvdimm_batt_IEOPS-1227.svg[width=500px]
