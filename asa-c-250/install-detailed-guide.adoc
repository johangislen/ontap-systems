...
summary: This section gives detailed step-by-step instructions for installing an ASA C250 system.
---
...
To install your ASA C250 system, you need to create an account and register the system. You also need to inventory the appropriate number and type of cables for your system and collect specific network information.
...
+
image::../media/drw_asac250_weight_caution.png[]
...
+
image:../media/drw_asac250_tnsc_cabling.png[]

. Cable the wrench ports to the management network switches with the RJ45 cables.
+
image::../media/drw_asac250_mgmt_cabling.png[]
...
+
image:../media/drw_asac250_switched_clust_cabling.png[]
...
+
image:../media/drw_asac250_fc_host_cabling.png[]
...
+
image:../media/drw_asac250_25gbe_host_cabling.png[]
--
...
+
image:../media/drw_asac250_1shelf_cabling_a.png[]

. Cable controller B to the shelf.
+
image:../media/drw_asac250_1shelf_cabling_b.png[]
--
...
+
image::../media/drw_console_client_mgmt_subnet_asac250.png[]
